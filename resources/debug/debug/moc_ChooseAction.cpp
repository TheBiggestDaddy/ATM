...
#include "../../../classes/gui/ChooseAction.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ChooseAction_t, stringdata) + ofs \
...
const QMetaObject ChooseAction::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_ChooseAction.data,
      qt_meta_data_ChooseAction,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ChooseAction.stringdata))
        return static_cast<void*>(const_cast< ChooseAction*>(this));
