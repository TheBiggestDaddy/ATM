...
#include "../../classes/gui/LoginScreen.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_LoginScreen_t, stringdata) + ofs \
...
const QMetaObject LoginScreen::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_LoginScreen.data,
      qt_meta_data_LoginScreen,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LoginScreen.stringdata))
